...
// ---    Thu Aug 18 15:09:14 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxpmWarpImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        WarpId {
            public Object get(XxpmWarpImpl obj) {
                return obj.getWarpId();
            }

            public void put(XxpmWarpImpl obj, Object value) {
        ...
        public abstract Object get(XxpmWarpImpl object);

        public abstract void put(XxpmWarpImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject =
                    EntityDefImpl.findDefObject("ncl.pm.model.bc.eo.XxpmWarp");
        }
    ...
    /**
     * Gets the attribute value for WarpId, using the alias name WarpId.
     * @return the WarpId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for WarpId.
     * @param value value to set the WarpId
     */
    ...
    /**
     * @param warpId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(DBSequence warpId) {
        return new Key(new Object[] { warpId });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        try {
            ...
            e1.printStackTrace();
            ma.showError(this.getDBTransaction(),
                         "There is an error in doDML method of XxpmWarpImpl. Class: " + e1.getClass());
            return;
        }
    }
