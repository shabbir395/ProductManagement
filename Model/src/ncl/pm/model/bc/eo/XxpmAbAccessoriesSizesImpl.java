...
// ---    Mon Aug 22 01:34:26 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxpmAbAccessoriesSizesImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        AbAccSizeId {
            public Object get(XxpmAbAccessoriesSizesImpl obj) {
                return obj.getAbAccSizeId();
            }

            public void put(XxpmAbAccessoriesSizesImpl obj, Object value) {
        ...
        public abstract Object get(XxpmAbAccessoriesSizesImpl object);

        public abstract void put(XxpmAbAccessoriesSizesImpl object,
                                 Object value);
     ...
     */
    public XxpmAbAccessoriesSizesImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject =
                    EntityDefImpl.findDefObject("ncl.pm.model.bc.eo.XxpmAbAccessoriesSizes");
        }
        return mDefinitionObject;
    }

    /**
     * Gets the attribute value for AbAccSizeId, using the alias name AbAccSizeId.
     * @return the AbAccSizeId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for AbAccSizeId.
     * @param value value to set the AbAccSizeId
     */
    ...
    /**
     * @param abAccSizeId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(DBSequence abAccSizeId) {
        return new Key(new Object[] { abAccSizeId });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        try {
            ...
            ma.showError(this.getDBTransaction(),
                         "There is an error in doDML method of XxpmAbAccessoriesSizesImpl. Class: " + e1.getClass());
            e1.printStackTrace();
            return;
        }
    }
